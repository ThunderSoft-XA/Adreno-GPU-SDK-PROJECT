...
const GLchar * fs_tex_filter = STRINGIZE(
	...
	void embossing5(void)
	{
		...
		vec4  t01 = texelFetchOffset(Texture, C, 0, ivec2(0, -2));
		vec4  t02 = texelFetchOffset(Texture, C, 0, ivec2(0, -2));
		vec4  t03 = texelFetchOffset(Texture, C, 0, ivec2(0, -2));
		vec4  t04 = texelFetchOffset(Texture, C, 0, ivec2(0, -2));

		vec4  t10 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t11 = texelFetchOffset(Texture, C, 0, ivec2(-2, 0));
		vec4  t12 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t13 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t14 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));

		vec4  t20 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t21 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t22 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t23 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t24 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));

		vec4  t30 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t31 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t32 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t33 = texelFetchOffset(Texture, C, 0, ivec2(-2, -4));
		vec4  t34 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));

		vec4  t40 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t41 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t42 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t43 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t44 = texelFetchOffset(Texture, C, 0, ivec2(-2, -4));

		vec4 r0 =  2.0 * t00 +  0.0 * t01 + 0.0 * t02 +  0.0 * t03 +  0.0 * t04;
		vec4 r1 =  0.0 * t10 +  2.0 * t11 + 0.0 * t12 +  0.0 * t13 +  0.0 * t14;
		vec4 r2 =  0.0 * t20 +  0.0 * t21 + 0.0 * t22 +  0.0 * t23 +  0.0 * t24;
		vec4 r3 =  0.0 * t30 +  0.0 * t31 +  0.0 * t32 +  -4.0 * t33 +  0.0 * t34;
		vec4 r4 =  0.0 * t40 +  0.0 * t41 +  0.0 * t42 +  0.0 * t43 +  -4.0 * t44;
	...
	void laplace2(void)
	{
		...
		vec4  t01 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t02 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));

		vec4  t10 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		vec4  t11 = texelFetchOffset(Texture, C, 0, ivec2(-2, 7));
		vec4  t12 = texelFetchOffset(Texture, C, 0, ivec2(-2, -2));
		...
		texel = -1.0*t00 + -1.0*t01 + -1.0*t02 + -1.0*t10 + 8.0*t11 + -1.0*t12 + -1.0*t20 + -1.0*t21 + -1.0*t22;
		clamp_vec4();
	}
